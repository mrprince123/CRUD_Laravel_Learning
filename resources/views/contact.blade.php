...
@section('main-section')
    <div class="m-auto p-10">
        ...
        <div class="w-2/3 bg-blue-50 mb-10 mt-10 justify-between m-auto flex p-2 text-xl">

            <div class="bg-blue-200 m-2 text-center w-1/4 p-4">
                <i class="fas fa-map-marker text-blue-500 text-3xl"></i>
                <h2 class="font-bold text-blue-500 m-2">Our Main Office</h2>
                <p class="m-2 text-sm">H-Block 206A, Noida, Uttar Pradesh, India</p>
            </div>

            <div class="bg-blue-200 m-2 text-center w-1/4 p-4">
                <i class="fas fa-phone text-blue-500 text-3xl"></i>
                <h2 class="font-bold text-blue-500 m-2">Our Phone</h2>
                <p class="m-2 text-sm">+91 345-435-3454</p>
            </div>

            <div class="bg-blue-200 m-2 text-center w-1/4 p-4">
                <i class="fas fa-envelope text-blue-500 text-3xl"></i>
                <h2 class="font-bold text-blue-500 m-2">Our Mail</h2>
        ...
        <div class="m-auto w-2/3 bg-blue-50 flex">
            <div class="w-1/2 p-2 m-auto">
                <h2 class="font-bold m-2 text-xl text-blue-400">Send a Message</h2>
                <form class="flex flex-col" action="{{ url('/') }}/contact" method="post">
                    ...
                    @error('email')
                        <label class="text-red-500">{{ $message }}</label>
                    @enderror
                    <input class="m-2 p-2 bg-white" type="tel" name="phone" placeholder="Your Phone"
                        value={{ old('phone') }}>
                    @error('phone')
                        <label class="text-red-500">{{ $message }}</label>
                    @enderror
                    <select class="m-2 p-2 bg-white" name="purpose">
                        ...
                        <option value="notres">Not Responding</option>
                    ...
                    @error('message')
                        <label class="text-red-500">{{ $message }}</label>
                    @enderror
                    <input type="submit" class="bg-blue-400 m-2 p-2 font-medium text-white" value="Send Message">
                </form>
            </div>
